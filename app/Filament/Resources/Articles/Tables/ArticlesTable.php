    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('category.name')->label('Topik')->badge()->placeholder('—')->toggleable(),
                TextColumn::make('author.name')->label('Penulis')->placeholder('—')->toggleable(),
            ...
            ->filters([
                ...
                TernaryFilter::make('is_featured')->label('Pilihan')->trueLabel('Pilihan')->falseLabel('Biasa')->placeholder('Semua'),
                TrashedFilter::make(),
            ])
