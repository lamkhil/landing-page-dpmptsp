...
class AnnouncementsTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                IconColumn::make('is_featured')->boolean()->label('📌')->trueIcon('heroicon-s-bookmark')->falseIcon('heroicon-o-bookmark'),
                TextColumn::make('title')->label('Judul')->searchable()->weight('semibold')->limit(70)->wrap(),
            ...
            ->filters([
                ...
                TernaryFilter::make('is_featured')->label('Disematkan')->trueLabel('Disematkan')->falseLabel('Biasa')->placeholder('Semua'),
                TrashedFilter::make(),
            ])
